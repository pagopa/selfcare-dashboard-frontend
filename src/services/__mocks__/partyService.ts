...
export const mockedBaseParties: Array<BaseParty> = [
  ...
  {
    partyId: 'sanVitoId',
    description: 'Comune di San Vito Al Torre',
    status: 'ACTIVE',
    userRole: 'ADMIN',
  },
  {
...
export const mockedParties: Array<Party> = [
  ...
  },
  {
    ...
    category: 'Comuni e loro Consorzi e Associazioni',
    categoryCode: 'L6',
    fiscalCode: '81001230309',
    digitalAddress: 'comune.sanvitoaltorre@certgov.fvg.it',
    registeredOffice: 'Via Roma 45',
    zipCode: '33050',
    geographicTaxonomies: [{ code: '030105', desc: 'SAN VITO AL TORRE - COMUNE' }],
    products: [
      {
        productId: 'prod-pagopa',
        userRole: 'ADMIN',
        authorized: true,
        billing: { vatNumber: '00470120304', publicServices: false },
        userProductActions: [
          'Selc:UploadLogo',
          'Selc:ViewBilling',
    ...
    products: [
      {
        ...
        productOnBoardingStatus: ProductOnBoardingStatusEnum.ACTIVE,
        userProductActions: COMMON_ADMIN_ACTIONS,
        institutionType: 'GPU',
        origin: 'IVASS',
        originId: '20128',
      },
  ...
  // Test PSP pagoPA
  {
    ...
    origin: 'IPA',
    institutionType: 'PSP',
    typology: 'Prestatore di servizi di pagamento',
    description: 'Prova PSP',
    fiscalCode: '94287592722',
    digitalAddress: 'pectest@pec.test.it',
    registeredOffice: 'Milano',
